 ...
 * @throws Error
 */
const validateOAuthConfiguration = (configuration) => {
  ...
  const builder = () => {
    return {
      ...
      withRawConfiguration: (rawConfiguration) => {
        // Assign the raw configuration to the configuration object
        // Dont forget that the configuration object is a constant
        Object.assign(configuration, rawConfiguration);
...
export default {
  ...
  STORAGE_MODES,
  AUTHORIZATION_MODES,
  ACCESS_CONTROL_LIST_SOURCE,
  validateOAuthConfiguration,
  validateConfigurationStorage,
  validateConfigurationAuthorization
};