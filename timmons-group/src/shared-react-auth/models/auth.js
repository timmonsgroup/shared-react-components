...
/**
 * @typedef { AUTH_STATES.INITIALIZING | AUTH_STATES.LOGGED_OUT | AUTH_STATES.LOGGING_IN | AUTH_STATES.LOGGED_IN | AUTH_STATES.TOKEN_STALE | AUTH_STATES.REFRESHING_TOKEN | AUTH_STATES.ERROR } AuthStateType - The auth state type
 */
