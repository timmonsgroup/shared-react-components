...
import {ConfigForm, NestedThing} from '../hooks/useConfigForm';
...
export const Template = (args) => {
  return (
    <Router>
      <ConfigForm formLayout={args.layoutOptions.layout} data={{
        moMoney: 100,
        fireDepartment: '7409'
      }}>
        <p> Am I A GAME? </p>
      ...
      {/* <GenericForm isEdit={true} defaultValues={{
        moMoney: 100,
        fireDepartment: '7409'
      }} {...args} />; */}
    </Router>
...
<Canvas>
  <Story name="Multi Section With Conditionals" argTypes={formArgs} args={defaultProps}>
    {Template.bind({})}
  </Story>
</Canvas>
